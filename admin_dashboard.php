                    ...
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#usermanage"
                                role="tab" aria-controls="nav-home" aria-selected="true">User Management</a>
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                                role="tab" aria-controls="nav-profile" aria-selected="false"> Payment Details</a>
                            <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#researchpaper"
                                role="tab" aria-controls="nav-about" aria-selected="false">Research paper</a>
                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#dspeakers"
                                role="tab" aria-controls="nav-contact" aria-selected="false">Speakers</a>

                        </div>
                    </nav>
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active  personal-info " id="usermanage" role="tabpanel"
                            aria-labelledby="nav-home-tab">

                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                        href="#createuser" role="tab" aria-controls="nav-home"
                                        aria-selected="true">Create User</a>
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                        href="#deleteuser" role="tab" aria-controls="nav-profile" aria-selected="false">
                                        Delete user</a>
                                    <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                        href="#userdetails" role="tab" aria-controls="nav-about" aria-selected="false">
                                        User Information</a>
                            ...
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                <div class="tab-pane fade show active  personal-info " id="createuser" role="tabpanel"
                                    aria-labelledby="nav-home-tab">
                                    <div class="col-md-12">
                                        <form>
                                ...
                                <div class="tab-pane fade research-info " id="deleteuser" role="tabpanel"
                                    ...
                                    <form>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="email">Email address</label>
                                                <input type="email" class="form-control" id="email"
                                                    placeholder="email address" aria-describedby="inputGroupPrepend">
                                            </div>
                        ...
                        <div class="tab-pane fade research-info " id="nav-profile" role="tabpanel"
                            aria-labelledby="nav-profile-tab">
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                        href="#paymentsuccess" role="tab" aria-controls="nav-home" aria-selected="true">
                                        Payment Submitted
                                    </a>
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                        href="#verifieduser" role="tab" aria-controls="nav-profile"
                                        aria-selected="false"> Verified Payment </a>
                                    <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                        href="#paymentnotsubmitted" role="tab" aria-controls="nav-about"
                                        aria-selected="false">Payment Not
                                        Submitted</a>

                                </div>
                            </nav>
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                <div class="tab-pane fade show active  personal-info " id="paymentsuccess"
                                ...
                                <div class="tab-pane fade research-info " id="verifieduser" role="tabpanel"
                                    aria-labelledby="nav-profile-tab">
                                    <form>
                                ...
                                <div class="tab-pane fade" id="paymentnotsubmitted" role="tabpanel"
                                    aria-labelledby="nav-about-tab">
                                    <form>
                        ...
                        <div class="tab-pane fade" id="dspeakers" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                        href="#addspeaker" role="tab" aria-controls="nav-home" aria-selected="true">Add
                                        Speakers</a>
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                        href="#viewspeakers" role="tab" aria-controls="nav-profile"
                                        aria-selected="false">View Speakers</a>
                                    <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                        href="#updatespeaker" role="tab" aria-controls="nav-about"
                                        aria-selected="false">Update Speaker</a>
                            ...
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                <div class="tab-pane fade show active  personal-info " id="addspeaker" role="tabpanel"
                                    aria-labelledby="nav-home-tab">
                                    <div class="container">
                                ...
                                <div class="tab-pane fade research-info " id="viewspeakers" role="tabpanel"
                                    aria-labelledby="nav-profile-tab">
