                ...
                <div class="row" style="padding:0px;margin:0px">
                    <div class="col-lg-4">
                        ...
                        <div class="bg-white regwarn">
                            <h6 class=" small  text-danger"><i class="fa fa-star fa-1x text-danger"></i>Name should be at least 5 character.<br>no number or special character allowed</h6>
                            <h6 class=" small  text-danger"><i class="fa fa-star fa-1x text-danger"></i>Password must contains at least one lowercase characters ,<br> must contains one uppercase characters,<br>must contains one special symbols in the list "@#$%" <br>must contains one digit from 0-9</h6>
                            <h6 class=" small  text-danger"><i class="fa fa-star fa-1x text-danger"></i>minimum size for password should be 8 characters</h6>
                    ...
                    <div class="col-lg-8">
                        <div class="card bg-light" style="padding:0px;margin:0px">
                            ...
                            <article class="card-body mx-auto">
                                ...
                                <form method="POST" name="registration" action="./process_regemp.php">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group input-group">
                                                ...
                                                <input name="name" class="form-control" placeholder="Full name" type="text" id="fullname" required>
                                            ...
                                            <div class="form-group input-group">
                                                ...
                                                <input name="mobile_no" class="form-control" placeholder="Phone number" type="number" maxlength="12" minlength="10"  required id="mobilenum1">
                                                <div class="invalid-feedback emsg small">
                                            ...
                                            <div class="form-group input-group">
                                                ...
                                                <input name="pass" class="form-control" placeholder="Create password" type="password" id="password123" required>
                                                <div class="invalid-feedback emsg">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group input-group">
                                                ...
                                                <input class="form-control" placeholder="Repeat password" type="password" id="repassword123" required>
                                                <div class="invalid-feedback emsg">
                                                    please enter password correctly
                                                </div>
                                            </div> <!-- form-group// -->
